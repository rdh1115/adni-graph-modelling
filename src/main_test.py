...
def get_args_parser():
    parser = GMAEParser(
        "GMAE_ST testing for classification or prediction", add_help=False
    )
...
def main(args):
    ...
    # if node feature includes MRI and PET,
    # then predict SUVR + MRI thickness and thickness average
    # otherwise, predict only PET SUVRs
